...
import { Map, FileText, CheckCircle2 } from "lucide-react";
...
export default function WhatHappensNext() {
  const t = useTranslations("home.whatHappensNext");
            ...
            return (
              <div key={key} className="relative">
                ...
                {index < stepKeys.length - 1 && (
                  <div className="hidden md:block absolute top-6 left-[calc(50%+24px)] w-[calc(100%-48px)] h-[2px] bg-gradient-to-r from-[var(--dd-border)] to-transparent" />
                )}
